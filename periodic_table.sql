...
--
-- Name: properties type_id_foreign_key; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT type_id_foreign_key FOREIGN KEY (type_id) REFERENCES public.types(type_id);
